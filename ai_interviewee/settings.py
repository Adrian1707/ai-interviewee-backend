"""
Django settings for ai_interviewee project.
...
ROOT_URLCONF = 'ai_interviewee.urls'
...
WSGI_APPLICATION = 'ai_interviewee.wsgi.application'
...
AUTHENTICATION_BACKENDS = [
    'ai_interviewee.utils.EmailBackend',
